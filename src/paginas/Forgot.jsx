                ...
                <div className="md:w-4/5 sm:w-full">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-1">
                            ...
                            <input type="email" onChange={(e)=>{setmail({email:e.target.value})}} placeholder="Enter you email" className="block w-full rounded-md border border-gray-300 focus:border-purple-700 focus:outline-none focus:ring-1 focus:ring-purple-700 py-1 px-1.5 text-gray-500" />
                        </div>
